...
*/
$config['tables']['users']           = TBL.'users';
$config['tables']['groups']          = TBL.'groups';
$config['tables']['users_groups']    = TBL.'users_groups';
$config['tables']['login_attempts']  = TBL.'login_attempts';
...
$config['default_group']              = 'subscriber';           // Default group, use name
